...
def open():
    #window
    window = Tk()
    functions.window_size_center(window, 400, 550)
    ...
    orCountryEntry = Entry(formFrame, font=("Helvetica", 12), bd=0)
    orCountryEntry.place(relx=0.5, rely=0.815, anchor="center")
    orCountryEntry.insert(0, "Country")
    functions.clearCountryEntry(orCountryEntry)
